...
public class GeoGcmListenerService extends GcmListenerService {
    ...
    public void onMessageReceived(String from, Bundle data) {
        ...
        Log.d(TAG, "From: " + from);
        Log.d(TAG, "Message: " + data.keySet());
        for(String keys : data.keySet()) {
            Log.d(TAG, "Message: " + keys);
        }
    ...
    private void sendNotification(String message) {
        Intent intent = new Intent(this, FBLoginActivity.class); //change to specified class
